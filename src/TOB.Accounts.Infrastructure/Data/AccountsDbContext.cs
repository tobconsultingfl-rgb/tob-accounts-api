...
public class AccountsDbContext : DbContext
{
    ...
    private void SeedLookupData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Industry>().HasData(
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000001"), Name = "Technology", Description = "Software, hardware, and IT services", IsActive = true, DisplayOrder = 1 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000002"), Name = "Healthcare", Description = "Medical and healthcare services", IsActive = true, DisplayOrder = 2 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000003"), Name = "Financial Services", Description = "Banking, insurance, and financial institutions", IsActive = true, DisplayOrder = 3 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000004"), Name = "Manufacturing", Description = "Production and manufacturing", IsActive = true, DisplayOrder = 4 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000005"), Name = "Retail", Description = "Retail and e-commerce", IsActive = true, DisplayOrder = 5 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000006"), Name = "Education", Description = "Educational institutions and services", IsActive = true, DisplayOrder = 6 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000007"), Name = "Real Estate", Description = "Real estate and property management", IsActive = true, DisplayOrder = 7 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000008"), Name = "Consulting", Description = "Professional consulting services", IsActive = true, DisplayOrder = 8 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000009"), Name = "Transportation", Description = "Transportation and logistics", IsActive = true, DisplayOrder = 9 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000010"), Name = "Energy", Description = "Energy and utilities", IsActive = true, DisplayOrder = 10 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000011"), Name = "Media & Entertainment", Description = "Media, entertainment, and publishing", IsActive = true, DisplayOrder = 11 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000012"), Name = "Agriculture", Description = "Agriculture and farming", IsActive = true, DisplayOrder = 12 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000013"), Name = "Telecommunications", Description = "Telecommunications services", IsActive = true, DisplayOrder = 13 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000014"), Name = "Hospitality", Description = "Hotels, restaurants, and hospitality", IsActive = true, DisplayOrder = 14 },
            new Industry { IndustryId = Guid.Parse("00000000-0000-0000-0002-000000000015"), Name = "Other", Description = "Other industries", IsActive = true, DisplayOrder = 99 }
        );
    }
